  ...
  const v3ListItems: ChatListItemData[] = [
    ...
    ...conversations
      ...
      .map((c): ChatListItemData => {
        ...
        return {
          ...
          type: 'conversation',
          name,
          ...(ou?.profileImageUrl !== undefined ? { avatarUrl: ou.profileImageUrl } : {}),
          initials: name.slice(0, 2).toUpperCase(),
          ...((c as any).lastMessageContent !== undefined ? { lastMessage: (c as any).lastMessageContent } : {}),
    ...
    ...channelsForList
      ...
      .map((ch): ChatListItemData => ({
        id: String(ch.id),
        type: 'channel',
        name: ch.name ?? t('chatPage.channelFallback'),
        initials: (ch.name ?? t('chatPage.channelFallback')).slice(0, 2).toUpperCase(),
        ...(ch.description != null ? { lastMessage: ch.description } : {}),
