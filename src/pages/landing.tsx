  ...
  return (
    <div className="mobile-container bg-white min-h-screen">
      ...
      <div className="px-6 py-12">
        ...
        <p className="text-gray-600 text-center mb-8">새로운 여행을 시작하세요</p>
      ...
      <div className="px-6 mb-12">
        ...
        <div className="space-y-4">
          {[
            { name: "김민수", rating: 5, comment: "현지인 추천으로 숨겨진 맛집을 발견했어요!" },
            { name: "이서연", rating: 5, comment: "혼자 여행도 안전하고 재미있게 할 수 있었어요" },
            { name: "박준혁", rating: 5, comment: "가이드북에 없는 특별한 경험을 할 수 있었습니다" }
          ].map((review, index) => (
      ...
      <div className="px-6 pb-8">
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mt-3">
            계정이 없으신가요? 로그인하면 자동으로 계정이 생성됩니다
          </p>
        </div>
      </div>
    </div>
