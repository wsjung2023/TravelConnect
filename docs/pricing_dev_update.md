# Tourgether 공유경제 결제 시스템 개발 계획서 v1.2

**작성일**: 2025년 11월 26일  
**수정일**: 2025년 12월 4일  
**목표**: 피드 기반 SNS의 안전한 P2P 거래 구조 구축

---

## 📌 핵심 정체성 (절대 잊지 말 것!)

> **Tourgether는 SNS입니다, 이커머스가 아닙니다!**
> - 모든 것은 **피드**에서 시작
> - 상품 판매가 아닌 **서비스 제안과 계약**
> - 누구나 돈을 벌 수 있는 **양방향 공유경제**

---

## 🏷️ Product Taxonomy (결제 유형 분류)

### 유형 1: P2P 계약 결제 (핵심 수익원)

| 구분 | 내용 |
|------|------|
| **정체** | 여행자 ↔ 로컬가이드 간 서비스 계약 |
| **트리거** | 피드에서 제안 → DM 협의 → 계약 체결 |
| **결제 방식** | 에스크로 (계약금 → 중도금 → 잔금) |
| **플랫폼 수수료** | 10-15% 자동 징수 |
| **PortOne 사용** | 1회성 결제 (정기결제 아님!) |

**서비스 유형:**
- 온라인: 예약대행, 정보제공, 통역, 가이드
- 오프라인: 차량, 숙박, 어드벤처, 쇼핑대행
- 이벤트: 주최/참여
- 보따리: 구매대행

### 유형 2: AI 크레딧 (Trip Pass) - 선택적

| 구분 | 내용 |
|------|------|
| **정체** | AI 기능 사용 크레딧 충전 |
| **결제 방식** | 1회성 구매 (정기결제 아님!) |
| **용도** | CineMap, AI Concierge, Mini Concierge |
| **소진 시** | 다시 구매 (자동 갱신 없음) |
...
| 구분 | 내용 |
|------|------|
| **정체** | 로컬가이드의 노출 부스트, 배지 등 |
| **결제 방식** | 월 정기결제 (PortOne 스케줄 적용) |
| **적용 대상** | 활발한 서비스 제공자만 |

---

## ⚠️ 중요: PortOne 정기결제 스케줄 적용 범위

| 유형 | 정기결제? | 설명 |
|------|----------|------|
| P2P 계약 | ❌ 아니오 | 건당 에스크로 결제 |
| Trip Pass | ❌ 아니오 | 1회성 크레딧 구매 |
| 프리미엄 기능 | ✅ 예 | 월 정기결제 (향후) |

**→ 섹션 0.5~0.6의 "정기결제 스케줄" 내용은 프리미엄 기능에만 적용!**

---

> 📌 **Tourgether의 고유한 특성**:
> - SNS + 공유경제 플랫폼 (이커머스 아님!)
> - 피드 기반 서비스 제안/요청 → DM 협의 → 계약
> - 여행자 → **에스크로** → 로컬가이드 자금 흐름
> - 계약 기반 분할 결제 (계약금/중도금/잔금)
> - 플랫폼 수수료 자동 징수 (10-15%)
> - 신뢰 & 안전이 핵심 (에스크로, 분쟁 해결)
